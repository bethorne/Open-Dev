...
$strXML = "<chart caption = 'Compras' bgColor='#CDDEE5' baseFontSize='12' showValues='1' xAxisName='Meses' formatNumberScale='0'>";
...
echo renderChartHTML("Column3D.swf", "",$strXML, "Ventas", 500, 400, false);
