...
<td valign='top' >
	...
	<label id='subtitulo'> Informe Deudas de Clientes</label>
	<br/>
	...
	<?php
		...
		if ($pfilas > 0)
		{
			...
			WHILE($linea = mysql_fetch_row($resp))
			{
				...
				echo "<td id ='data'><a id='etiquetazul' href='informedeudacliente.php?x=".$rutcli."'target='_blank'>".$nombre."<br/>(".$rutcli.")</b></a></td>";
