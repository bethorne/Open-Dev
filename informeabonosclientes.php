...
<td valign='top' >
	...
	<label id='subtitulo'> Informe Abonos/Pagos  Clientes</label>
	<br/>
	...
	<?php
		...
		$proveedores  = "SELECT DISTINCT(rut_cli) FROM tbk_abono ORDER BY rut_cli ASC";
		...
		if ($pfilas > 0)
		{
			...
			WHILE($linea = mysql_fetch_row($resp))
			{
				...
				echo "<td id ='data'><a id='etiquetazul' href='informeabonocliente.php?x=".$rutcli."' target='_blank'>".$rutcli."</td>";
