...
<td valign='top' >
	...
	<form name='boleta' action='crearnotas.php?cb=<?=$cb?>' method ='POST'>
		...
		<td width='400' valign='top'>
				...
				<fieldset>
					...
					<td valign='top' width='16'>
							<input type='image' src='images/binoculares.gif' onClick='boleta.look.value=1; boleta.submit()'>
					</td>
					...
					<td valign='top' width='16'>
							<input type='image' src='images/binoculares.gif' onClick='boleta.look.value=2; boleta.submit()'>
					</td>
					</tr>
					...
					<?php
						...
						if ($busqueda == 1)
						{
							...
							SWITCH($tipodoc)
							{
								...
								echo "<tr><td id='data' width='20'><a id='etiquetazul' href='crearnotas.php?cb=".$facturaID."'><font size='4'>".$codigodoc."</font></a></td><td id='data'>".$clienteID."</td><td id='data'>".$fechafact."</td><td id='data'>$ ".$total."</td><td id='data'>".$proceso."</td></tr>";
								$i++;
							}
						}
						else
