...
<td valign='top' >
	...
	<form name='np' action='creditoshistorial1.php' method ='POST'>
				...
				<?php
						...
						if ($busqueda == 1)
						{
							...
							While ($row = mysql_fetch_row($res))
							{
								...
								echo "<tr><td id='data' width='20'><a id='menualternativo' href='informedeudaclientedetalle.php?x=".$srut."'><img src='images/flechita.gif' border='0'></a></td><td id='data' width='100'><label id='menualternativo' >".$srut."</label></td><td id='data'>".$snombre."</td><td id='data'>".$spaterno." ".substr($smaterno,0,1)."</td><td id='data'>".$sdeudatotal."</td></tr>";
								$i++;
							}
						}
						else
