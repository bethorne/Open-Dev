...
*/			
		...
		function validatransaccion()
		{
			...
			{
				alert("Mensaje del Sistema:\n\n> Campo Tipo Capacitación vacío.\n\n# Complete el campo Tipo de Capacitación seleccionando una de las opciones.\n\n");
			...
			{
				alert("Mensaje del Sistema:\n\n> Campo Institución vacío.\n\n# Complete el campo Tipo de Capacitación seleccionando una de la lista de instituciones o ingrese una nueva si es necesario.\n\n");
		...
		function calcularcuota(cuota)
		{
				...
				{
					alert("Mensaje de Alerta\n\nCampo 'Total Vale' está vacío.\n\nPor favor presione el botón con el signo '=' a un lado del campo 'descuento' para realizar el cálculo.");
		...
		function totalabono()
		{
			...
			{
					alert("Mensaje de alerta\n\nAbono de crédito excede saldo del crédito");
		...
		if (!empty($rut)) 
		{
			...
			case '4':
					...
					<td  background='images/logos/fondo_boton_menu.jpg' height='50'>
                     ...
                     <td background='images/logos/fondo_boton_menu.jpg' height='50'>
						<a id='mainmenu' href='subventas.php?c=2'>COTIZACIÓN.</a>
					</td>
                    <!----> <td background='images/logos/fondo_boton_menu.jpg' height='50'>
