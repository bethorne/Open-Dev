...
<?php
	...
	echo "<form name='boleta' action='guardadocumentocotizacion.php' method='POST'>\n";
...
<td valign='top' align ='center'>
	...
	<label id='subtitulo'> COTIZACI&Oacute;N </label>
	<p/>
	...
	<td id ='data' colspan='5'>
		NOTA: Si el <b>VALE DE COMPRA</b> es convertido a <b><i>GU&Iacute;A</i></b>, entonces los productos de la lista <b><i>deben ser despachados inmediatamente</i></b>.
	</td>
	</tr>
	</table>
<?php	
...
?>
	...
	<td align='right'>
		...
		<input type='button' value='Editar Boleta' onClick='document.boleta.action = "cotizacion.php?IDcliente=<?=$IDcliente?>&tp=<?=$tp?>"; submit();'>
