...
$update = "UPDATE tbk_arriendo SET tipo_doc = ".$tipodoc.",codigo_doc = ".$codigodoc." WHERE id_doc=".$cb;
	...
	if (!empty($cb))
	{
			if ($insertfac = mysql_query($update,$conn))
			{
				...
				$searchgv = "SELECT * FROM tbk_arriendo WHERE id_doc = ".$cb;
				...
				WHILE($b < $elementos)
				{
					...
					$updateguia = "UPDATE tbk_arriendo SET estado_doc = 0, guias_doc ='".$cb."' WHERE id_doc = ".$cadaguia[$b];
				...
				*/
				...
				$buscapro  = "SELECT * FROM tbk_docarr WHERE id_doc =".$cb;
...
<td id='comentario'> Forma de pago registrada exitosamente. </td>

<td id='data'><img src='images/logos/cuota.jpg' height='20'></td>
<td id='comentario'>Cuota registrada exitosamente. </td>

<td id='data'><img src='images/logos/producto.jpg' height='20'></td>
<td id='comentario'>Producto registrada en k&aacute;rdex. </td>

<td id='data'><img src='images/logos/documento.jpg' height='20'></td>
<td id='comentario'> Documento registrado exitosamente. </td>
</tr>
</table>
...
<td id='data' valign='bottom'  align='center'>
		<a id='menu' href='home.php'><img src="images/logos/aceptar0.jpg" onmouseover="this.src = 'images/logos/aceptar1.jpg'" onmouseout="this.src = 'images/logos/aceptar0.jpg'" border="0"></img></a>
</td>
