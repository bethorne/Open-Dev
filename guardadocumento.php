...
<?php
	...
	$insert = "INSERT INTO tbk_documento VALUES(";
	$insert .= "'',";
	$insert .= "'".$IDcliente."',";
	$insert .= "'0',";
	$insert .= "'".$fechadoc."',";
	...
	echo "<td id='data' align='center'>";
			...
			if ($insertfac = mysql_query($insert,$conn))
			{
				...
				WHILE (!empty($codigo[$p]))
				{
						...
						$insertP = "INSERT INTO tbk_docpro VALUES(";
						$insertP .= "'".$IDdocumento."',";
						$insertP .= "'".$pcodigo ."',";
						$insertP .= "'".$pdespacho ."',";
						$insertP .= "'".$pcantidad ."',";
		...
		echo "<br/>";
		echo "<table border='0'><tr><td id='data'><img src='images/documento.jpg' height='30'> </td><td > <label id='menu'>Documento grabado exitosamente</label> </td></tr>";
		echo "</tr><td id='data'><img src='images/producto.jpg' height='30'></td><td ><label id='menu'> Producto almacenado exitosamente</label></td></tr></table>";
		
		echo "<p/>";
		
		echo "<table border='0' cellspacing='5' cellpadding='5' height='50'>";
		echo "<tr>";
		echo "<td id='data' align='center'><a  href='historial.php'><img src='images/nuevo.jpg' border='0' height='30'><br/>NUEVA VENTA</a> </td><td id='data' align='center'>  <a   href='vervale.php?cb=".$IDdocumento."' target='popup'  onClick='window.open(this.href, this.target, \"width=500,height=600\"); return false;'> <img src='images/lupa.png'  height='30' border='0'><br/>VER VALE</a> </td> <td id='data' align='center'><a  href='vales.php?cb=".$IDdocumento."'><img src='images/documento.jpg' border='0' height='30'><br/> GENERAR DOCUMENTO </a></td>";
		echo "</tr></table>";
