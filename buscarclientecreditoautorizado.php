...
<td valign='top' >
	...
	<form name='np' action='buscarclientecreditoautorizado.php' method ='POST'>
				...
				<?php
					...
					if ($busqueda == 1)
					{
						...
						While ($row = mysql_fetch_row($res))
						{
							...
							echo "<tr><td id='data' width='100'><a id='etiquetazul' href='buscarclientecreditoautorizado.php?cb=".$srut."'>".$srut."</a></td><td id='data'>".$snombre."</td><td id='data'>".$spaterno." ".substr($smaterno,0,1)."</td></tr>";
							$i++;
						}
					}
					else
...
<td valign='top' >
	...
	<td valign='top' >
		...
		<label id='subtitulo'>Cr&eacute;dito Autorizado</label>
		...
		<fieldset>
			...
			<td id='etiqueta'>
				...
				Alerta<p/>
				El <b>Cr&eacute;dito Autorizado</b> es un  cr&eacute;dito especial, otorgado a un cliente, el cual  tiene la caracter&iacute;stica de convertirse en el &uacute;nico cr&eacute;dito activo asignado al cliente. Generalmente a un cliente s&oacute;lo se le autoriza un solo cr&eacute;dito, por lo cual no es posible asignarle uno nuevo hasta que el anterior se termine.
				<br/>
				Bien, este cr&eacute;dito autorizado, una vez asignado, deshabilita el cr&eacute;dito anterior y lo reemplaza por este nuevo.
	...
	<td align='right'>
		...
		<tr>
		<td>
			<input type='text' name='rutcli' value='<?=$nrut?>'>
			<input type='submit' value='Aceptar' onCLick='np.action="procesacreditoautorizado.php"; submit()'>
		</td>
		</tr>
		</table>
