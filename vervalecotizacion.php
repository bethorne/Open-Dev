...
<?php
	...
	if (!empty($see))
	{
		...
		SWITCH($see)
		{
			...
			case '1':
					$insert = "SELECT * FROM tbk_cotizacion WHERE id_fact doc '%".ltrim($codigofactura)."%' AND tipo_doc = 3 ORDER BY id_fact DESC";
					break;
...
<td valign='top' >
	...
	<?php if (!empty($cb)) :?>
			...
			<tr><td id='etiqueta'> Producto</td><td id='etiqueta' align='center'> Cant.</td><td id='etiqueta' width='30' align='center' >  Valor</td><td id='etiqueta' width='30' align='center'>  Total</td></tr>
