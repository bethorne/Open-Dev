...
<?php
	...
	echo "<form name='boleta' action='guardadocumento.php' method='POST'>\n";
...
<td valign='top' align ='center'>
	...
	<label id='subtitulo'> VALE DE COMPRA </label>
	<p/>
...
?>
	...
	<td align='right'>
		...
		<input type='button' value='Editar Boleta' onClick='document.boleta.action = "caja.php?IDcliente=<?=$IDcliente?>&tp=<?=$tp?>"; submit();'>
