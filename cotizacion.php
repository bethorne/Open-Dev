...
<td valign='top' >
	...
	<label id='subtitulo'> COTIZACION</label>
	<br/>
	<label id='comentariogris'>Seleccione los productos que desea cotizar y agr&eacute;guelos a la vista.</label>
	<hr/>
	<p/>
	
	
	<form name='np' action='cotizacion.php?IDcliente=<?=$IDcliente?>&tp=<?=$tp?>' method ='POST'>
	...
	<td valign='top'>
			...
			<td id='data'>
						...
						<a href='elegirproductoventa.php?pos=<?=$p?>' id='menublanco' target="popup"  onClick="window.open(this.href, this.target, 'width=800,height=700'); return false;"><img src='images/binoculares.gif'></a>
			</td>
			<td id='etiqueta'>
				Cantidad
			...
			<table border='0' cellspacing='5' cellpadding='5' >
					...
					<td id='data' valign='bottom' align='center'>
							<a  id='menualternativo' href='home.php' onClick='np.lista.value=""' ><img src="images/logos/cancelar0.jpg" onmouseover="this.src = 'images/logos/cancelar1.jpg'" onmouseout="this.src = 'images/logos/cancelar0.jpg'" border="0"></img></a><br/>
					</td>
					<td id='data' valign='bottom'  align='center'>
					...
					<td id='data' valign='bottom'  align='center'>
							<a id='menu' href='#'   onClick='document.np.action="generadocumentocotizacion.php"; submit()'><img src="images/logos/vale0.jpg" onmouseover="this.src = 'images/logos/vale1.jpg'" onmouseout="this.src = 'images/logos/vale0.jpg'" border="0"></img></a>
					</td>
					</tr>
			</table>
