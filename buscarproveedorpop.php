...
<td valign='top' >
	...
	<form name='np' action='buscarproveedorpop.php' method ='POST'>
				...
				<?php
					...
					if ($busqueda == 1)
					{
						...
						While ($row = mysql_fetch_row($res))
						{
							...
							echo "<tr><td id='etiqueta' width='5'><a href='#' onClick='window.opener.boleta.nrut.value=\"".$srut."\";  window.close()'><img src='images/flechaizq.jpg' border='0'></a></td><td id='data' width='100'>".$srut."</td><td id='data'>".$snombre."</td></tr>";
							$i++;
						}
					}
					else
