...
<?php
	...
	$insert = "INSERT INTO tbk_cotizacion VALUES(";
	$insert .= "'',";
	$insert .= "'".$IDcliente."',";
	$insert .= "'0',";
	$insert .= "'".$fechadoc."',";
	...
	echo "<td id='data' align='center'>";
			...
			if ($insertfac = mysql_query($insert,$conn))
			{
				...
				WHILE (!empty($codigo[$p]))
				{
						...
						$insertP = "INSERT INTO tbk_doccot VALUES(";
						$insertP .= "'".$IDdocumento."',";
						$insertP .= "'".$pcodigo ."',";
						$insertP .= "'".$pdespacho ."',";
						$insertP .= "'".$pcantidad ."',";
		...
		echo "<tr>";
		echo "<td id='data' align='center'><a id='menu' href='historialcotizacion.php'><img src='images/nuevo.jpg' border='0' height='30'><br/>NUEVA COTIZACION</a> </td><td id='data' align='center'>  <a id='menu' href='vervalecotizacion.php?cb=".$IDdocumento."' target='popup'  onClick='window.open(this.href, this.target, \"width=500,height=600\"); return false;'> <img src='images/lupa.png'  height='30' border='0'><br/>VER VALE</a> </td> ";
		echo "</tr></table>";
