<?php  include("header.php")  ;?>
	...
	if (($periodo != '') AND ($yearguia != ''))
	{
		...
		//echo "<p> Hay datos,, preguntemos ";
			...
			$searchgv="SELECT *  FROM tbk_documento WHERE codigo_doc <>  '' AND SUBSTR( fecha_doc, 4, 2 ) =  '".$periodo."' AND SUBSTR( fecha_doc, 7, 4 ) =  '".$yearguia."' AND tipo_doc=3 ORDER BY codigo_doc";
	...
	?>
<center>
<form action='informeventas1.php' name='gv' method='POST'>
<table border='0' width='890' height='400'>
<tr>
<td valign='top' >

	<label id='subtitulo'> Libro Contable de Ventas</label>
	<br/>
...
<center>
  <table border='0' width='650' cellpadding='5'>
	...
	<?php
		...
		if ($pfilas > 0)
		{
			...
			WHILE($linea = mysql_fetch_row($resp))
			{
				...
				echo "<td id ='".$fondo."' align='right'>".$documento."  ".$proceso."</td>";
    ...
    <table width="200" border="0">
	  <tr>
	    <td><a  target="_new" href="pdf03.php?periodo=<?php echo"$periodo"?>&year=<?php echo"$yearguia";?>"><img src="images/Exportar_a_Pdf.png" width="56" height="53" alt="Exportar a PDF" /></a></td>
	    <td><a target="_new" href="mysql.php?periodo=<?php echo"$periodo"?>&year=<?php echo"$yearguia";?>"><img src="images/Exportar_a_excel.png" width="47" height="52" alt="Exportar a Excel" /></a></td>
	    <td>&nbsp;</td>
	    </tr>
	  </table>
	</center>
