		...
		SWITCH($see)
		{
			...
			case '9':
					...
					if ($flag == 1)
						...
						$insertar =" INSERT INTO tbk_cajadiaria (fecha_ca,cajachica_ca) VALUES (";
						$insertar .= "'".$fechakdx."',";
						$insertar .= "'".$cantidad."')";
						...
						{
							$tipomensaje=1;
							$texto = "El registro de la caja ha sido registrado exitosamente.";
							include("mensaje.php");
						...
						{
							//echo "NO SE GRABO! HAY QUE ACTUALIZAR";						
							$insertar =" UPDATE tbk_cajadiaria SET ";
							$insertar .= "cajachica_ca ='".$cantidad."' ";
							$insertar .= " WHERE  fecha_ca ='".$fechakdx."'";
					...
					else
					{
							...
							$tipomensaje=0;
							$texto = "El registro de la caja no ha sido registrado. Revise que ning&uacute;n campo est&eacute; vac&iacute;o. Si  el problema persiste, comun&iacute;quese con el administrador del sistema.";
							include("mensaje.php");
...
<td valign='top' >
	...
	<label id='subtitulo'>CAJA CHICA </label>
	<br/>
	<label id='comentariogris'>Registro de efectivo en la caja al inicio de la jornada.</label>
	<hr/>
	<p/>


	<form name='np' action='cajachica.php' method ='POST'>
