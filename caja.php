...
<?php
	...
	// agregando producto nuevo ------------------------------------------------
		if ($codigo != '')
			...
			{
					$tipomensaje = 0;
					$texto=" Atenci&oacute;n<p/>El producto <b> ".$np."</b> no tiene STOCK.";
					include("mensaje.php");
					$codigo = "";
			...
			{
					$tipomensaje = 0;
					$texto=" Atenci&oacute;n<p/>El STOCK del producto <b> ".$np."</b> no suficiente, por favor ingrese menos cantidad ";
					include("mensaje.php");
					$codigo = "";
...
<td valign='top' >
	...
	<label id='subtitulo'> Venta aCliente</label>
	<br/>
	<label id='comentariogris'>Seleccione los productos que desea vender y agr&eacute;guelos a la vista.</label>
	<hr/>
	<p/>
	
	<input type='hidden' name='IDcliente' value='<?=$tp?>'>
