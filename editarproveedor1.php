...
<td valign='top' >
	...
	<form name='np' action='editarproveedor.php' method ='POST'>
				...
				<?php
					...
					if ($busqueda == 1)
					{
						...
						While ($row = mysql_fetch_row($res))
						{
							...
							echo "<tr><td id='data' width='20'><a id='menualternativo' href='editarproveedor.php?cb=".$srut."'><img src='images/flechita.gif' border='0'></a></td><td id='data' width='100'><a id='etiquetazul' href='editarproveedor.php?cb=".$srut."'>".$srut."</a></td><td id='data'>".$snombre."</td><td id='data'>".$spaterno." ".substr($smaterno,0,1)."</td></tr>";
							$i++;
						}
					}
					else
