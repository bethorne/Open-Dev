...
function limpiar($string )
{
	...
	if (!empty($see))
	{
		...
		SWITCH($see)
		{
			...
			case '1':
					$insert = "SELECT *, MATCH(nombre_pro,codigo_pro) AGAINST('".trim($nombre)."') FROM tbk_producto WHERE MATCH(nombre_pro,codigo_pro) AGAINST('".trim($nombre)."') ORDER BY  nombre_pro ASC ";
					break;
			...
			case '9':
					...
					$insertar =" INSERT INTO tbk_inventario VALUES (";
					$insertar .= "'".$fechakdx."',";
					$insertar .= "'".$idpro."',";
					$insertar .= "'".$cantidad."',";
					$insertar .= "'".$irut."',";
					...
					// actualizar stock del producto
						$insert = "INSERT INTO tbk_stock (id_pro, stock_stk) VALUES (";
						$insert .= "'".$idpro."',";
						$insert .= "'".$cantidad."'";
						$insert .= ")";
						//echo $insert;
						...
						else
						{
							...
							$update.= " stock_stk ='".$cantidad."' ";
							$update.= " WHERE id_pro ='".$idpro."'";
							
							if($resup = mysql_query($update, $conn)) echo "actualizado";
						...
						if ($reskdx  = mysql_query($insertkdx, $conn)) echo "<p/>OK KARDEX<p/>";
							...
							$tipomensaje = 1;
							$texto = "El inventario ha sido registrado exitosamente. Este registro ahora  es parte del Kardex del producto.";
							include("mensaje.php");
					...
					{
							$tipomensaje = 0;
							$texto = "No fue posible ingresar el inventario del producto. Consulte con el administrador para mayor informaci&oacute;n.";
							include("mensaje.php");
...
<td valign='top' >
	...
	<form name='np' action='inventario_nuevo.php?cb=<?=$cb?>' method ='POST'>
				...
				<?php
					...
					if ($busqueda == 1)
					{
						...
						While ($row = mysql_fetch_row($res))
						{
							...
							echo "<tr><td id='etiqueta' width='5'><img src='images/flechita.gif' border='0'></td><td id='data' width='20'><a id='etiquetazul' href='inventario_nuevo.php?cb=".$scbarra."'>".$scbarra."</a></td><td id='data'>".$snombre."</td><td id='data'>".$smarca."</td><td id='data'>".$smodelo."</td></tr>";
							$i++;
						}
					}
					else
	...
	<?php if (!empty($cb)) :?>
			...
			<?php
				...
				?>	
					<p/>
					<label id='subtitulo'>Inventario de producto </label>
					<p/>
